...
public final class LeperKeys {
   ...
   public final NamespacedKey quarantineLanternKey;
   public final NamespacedKey lanternChunkKey;
   ...
   public LeperKeys(Plugin plugin) {
      ...
      this.quarantineLanternKey = new NamespacedKey(plugin, "quarantine_lantern");
      this.lanternChunkKey = new NamespacedKey(plugin, "lanterns");
   }
}
