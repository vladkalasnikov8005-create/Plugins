...
public final class LeperTabCompleter implements TabCompleter {
   public List<String> onTabComplete(CommandSender sender, Command command, String alias, String[] args) {
      if (!command.getName().equalsIgnoreCase("leper")) {
         ...
         return this.filter(Arrays.asList("add", "remove", "menu", "bless", "unbless", "sneeze", "lantern", "status", "migrateitems"), args[0]);
